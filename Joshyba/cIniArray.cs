...
namespace Joshyba
{
    public class cIniArray
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cIniArray"/> class.
        /// </summary>
        /// <param name="path">The ini file to read and write from.</param>
        public cIniArray(string path)
        {
                                ...
                                string defaultValue)
        {
            ...
            StringBuilder retval = new StringBuilder(cIniArray.MaxSectionSize);

            NativeMethods.GetPrivateProfileString(sectionName,
                                                  keyName,
                                                  defaultValue,
                                                  retval,
                                                  cIniArray.MaxSectionSize,
                                                  m_path);
                                ...
                                double defaultValue)
        {
            ...
            if (!Double.TryParse(str, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out retval))
                retval = defaultValue;
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            IntPtr ptr = Marshal.AllocCoTaskMem(cIniArray.MaxSectionSize);
        ...
        public string[] GetSectionNames()
        {
            ...
            try
            {
                ...
                len = NativeMethods.GetPrivateProfileSectionNames(ptr,
                    cIniArray.MaxSectionSize, m_path);
        ...
        {
            WriteValue(sectionName, keyName, value.ToString(System.Globalization.CultureInfo.InvariantCulture));
        }
